...
<div class="admin-content-inner !max-w-[860px]">
    ...
    <div class="adm-card !p-0 overflow-hidden">
        <div class="py-5 px-6 border-b border-white/5">
        ...
        <div class="adm-table-wrap !border-none !rounded-none">
            <table class="adm-table" id="tabla-marcas">
                ...
                <tbody>
                <?php if (empty($marcas)): ?>
                <tr><td colspan="4" class="text-center py-8 text-[#555]">No hay marcas registradas</td></tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex gap-1.5 flex-wrap">
                            <button class="adm-btn adm-btn-warning btn-editar-marca !text-[0.72rem] py-[0.3rem] px-[0.7rem]"
                                data-marca='<?= json_encode(["id"=>$m["id"],"nombre"=>$m["nombre"],"descripcion"=>$m["descripcion"]]) ?>'>
                                Editar
                            </button>
                            <button type="button" class="adm-btn adm-btn-danger !text-[0.72rem] py-[0.3rem] px-[0.7rem]"
    ...
    <div id="pag-marcas" class="flex items-center justify-center gap-2 mt-4 flex-wrap"></div>
...
<div id="modal-editar-marca" class="adm-modal hidden">
    <div class="adm-modal-box">
        ...
        <form id="form-editar-marca" class="flex flex-col gap-4">
