        ...
        <div>
            ...
            <div class="footer-social-links">
                ...
                <a href="https://www.facebook.com/profile.php?id=100054648720157" target="_blank"
                    rel="noopener noreferrer" class="footer-social-icon footer-social-fb" aria-label="Facebook">
                    <span class="footer-social-glow"></span>
                ...
                <a href="https://www.instagram.com/compu_tecnicos/" target="_blank" rel="noopener noreferrer"
                    class="footer-social-icon footer-social-ig" aria-label="Instagram">
                    <span class="footer-social-glow"></span>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
