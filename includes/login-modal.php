      ...
      <form class="w-full" id="modal-form-register-simple" autocomplete="off">
        ...
        <div class="reg-step" id="reg-step-3">
          ...
          <div class="glass-input-group">
            ...
            <input type="text" id="register-simple-codigo" class="glass-input" placeholder="Código de 6 dígitos" maxlength="6" inputmode="numeric" pattern="[0-9]*" autocomplete="one-time-code" style="text-align:center;font-size:1.3rem;letter-spacing:8px;font-weight:700">
          </div>
