...
CREATE TABLE IF NOT EXISTS pedidos (
    ...
    estado ENUM('pendiente','pagado','preparacion','enviado','entregado','cancelado') DEFAULT 'pendiente',
...
CREATE TABLE IF NOT EXISTS pedido_estados (
    ...
    estado ENUM('pendiente','pagado','preparacion','enviado','entregado','cancelado') NOT NULL,
    fecha DATETIME DEFAULT CURRENT_TIMESTAMP,
...
(1, 'Laptops',       'Portátiles para trabajo, estudio y gaming'),
(2, 'Computadoras',  'Equipos de escritorio y estaciones de trabajo'),
(3, 'Componentes',   'Partes y piezas para ensamblaje y upgrade'),
(4, 'Accesorios',    'Periféricos y complementos para tu equipo')
ON DUPLICATE KEY UPDATE nombre=VALUES(nombre), descripcion=VALUES(descripcion);

-- Marcas
INSERT INTO marcas (id, nombre, descripcion) VALUES
(1, 'ASUS',      'Líder en hardware y electrónica'),
(2, 'HP',        'Hewlett-Packard — soluciones informáticas'),
(3, 'Lenovo',    'Innovación para todos'),
(4, 'Dell',      'Tecnología empresarial y personal'),
(5, 'MSI',       'Hardware gaming y profesional'),
(6, 'Corsair',   'Periféricos y componentes gaming'),
(7, 'Logitech',  'Periféricos de alta calidad'),
(8, 'Kingston',  'Memorias y almacenamiento')
ON DUPLICATE KEY UPDATE nombre=VALUES(nombre), descripcion=VALUES(descripcion);

-- ══════════════════════════════════════
-- PRODUCTOS: Laptops (categoría 1)
-- ══════════════════════════════════════
INSERT INTO productos (nombre, descripcion, precio, stock, imagen, id_categoria, id_marca, oferta, sku, stock_minimo, costo_unitario, iva_porcentaje) VALUES
('ASUS ROG Strix G16',
 ...
 5499900, 8, 'https://dlcdnwebimgs.asus.com/gain/82E3E463-B3E4-4895-B48D-C649B62B579E/w1000/h732', 1, 1, 1, 'LAP-ASUS-001', 2, 4200000, 19.00),
...
('HP Pavilion 15-eh2025',
 ...
 2199900, 15, 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lowres/c08520866.png', 1, 2, 0, 'LAP-HP-001', 3, 1700000, 19.00),
...
('Lenovo IdeaPad 3 15IAU7',
 ...
 2499900, 12, 'https://p4-ofp.static.pub/ShareResource/na/subseries/hero/lenovo-laptops-ideapad-3-background.png', 1, 3, 0, 'LAP-LEN-001', 3, 1900000, 19.00),

('Dell Inspiron 15 3520',
 'Laptop Intel Core i5-1235U, 16GB DDR4 RAM, 512GB SSD, pantalla 15.6" FHD, cámara HD con micrófono, HDMI, USB-C, Windows 11.',
 2799900, 10, 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/inspiron-notebooks/15-3520/media-gallery/in3520nt-cnb-00000ff090-sl.psd', 1, 4, 1, 'LAP-DELL-001', 2, 2100000, 19.00),
...
('MSI Katana 15 B13VFK',
 ...
 5999900, 5, 'https://asset.msi.com/resize/image/global/product/product_1678435030c06ee8ccddafdee481ba4f90e5a21c76.png62405b38c58fe0f07fcef2367d8a9ba1/1024.png', 1, 5, 1, 'LAP-MSI-001', 2, 4600000, 19.00);
...
('ASUS ExpertCenter D5 Mini Tower',
 ...
 3299900, 6, 'https://dlcdnwebimgs.asus.com/gain/07F37D58-F519-4D4E-8EDB-2C3E0A126C56/w1000/h732', 2, 1, 0, 'PC-ASUS-001', 2, 2500000, 19.00),
...
('HP Pro Tower 400 G9',
 ...
 3999900, 4, 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lowres/c08413850.png', 2, 2, 0, 'PC-HP-001', 2, 3100000, 19.00),
...
('Lenovo ThinkCentre M70q Gen4',
 ...
 2599900, 9, 'https://p4-ofp.static.pub/ShareResource/na/subseries/hero/lenovo-desktops-thinkcentre-702.png', 2, 3, 1, 'PC-LEN-001', 3, 1900000, 19.00),
...
('Dell OptiPlex 7010 SFF',
 ...
 3699900, 7, 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/desktops/optiplex-702x-702x-702x/media-gallery/optiplex-702x-702x-702x-702x.psd', 2, 4, 0, 'PC-DELL-001', 2, 2800000, 19.00),
...
('MSI MAG Infinite S3 13-661',
 ...
 4799900, 3, 'https://asset.msi.com/resize/image/global/product/product_16784360805fbd1b08b5c0d54e6f7ab3a9f2c94a79.png62405b38c58fe0f07fcef2367d8a9ba1/1024.png', 2, 5, 1, 'PC-MSI-001', 1, 3700000, 19.00);
...
('ASUS ROG Strix B760-F WiFi',
 ...
 899900, 14, 'https://dlcdnwebimgs.asus.com/gain/D6EDBA14-02F3-4E8B-89CD-C53E24DB42AE/w1000/h732', 3, 1, 0, 'COM-ASUS-001', 5, 680000, 19.00),
...
('Corsair Vengeance DDR5 32GB (2x16GB)',
 ...
 449900, 25, 'https://www.corsair.com/medias/sys_master/images/images/h1e/h39/67388309913630/CMK32GX5M2B5600C36.png', 3, 6, 1, 'COM-COR-001', 5, 320000, 19.00),
...
('Kingston NV2 SSD 1TB NVMe',
 ...
 219900, 30, 'https://media.kingston.com/kingston/product/ktc-product-ssd-snv2s-702x702.png', 3, 8, 0, 'COM-KNG-001', 8, 155000, 19.00),
...
('MSI GeForce RTX 4070 Ventus 2X',
 ...
 2899900, 6, 'https://asset.msi.com/resize/image/global/product/product_16798373902c3da5ef8f6be78f3e93c85c3edb5cc5.png62405b38c58fe0f07fcef2367d8a9ba1/1024.png', 3, 5, 1, 'COM-MSI-001', 2, 2200000, 19.00),
...
('Corsair RM850x Fuente 850W 80+ Gold',
 ...
 549900, 11, 'https://www.corsair.com/medias/sys_master/images/images/hc3/h72/67302988029982/CP-9020200-NA.png', 3, 6, 0, 'COM-COR-002', 3, 400000, 19.00);
...
('Logitech G Pro X Superlight 2',
 ...
 599900, 18, 'https://resource.logitechg.com/w_1000,c_limit,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/gaming/en/products/pro-x2-702x702-702x702-702x702.png', 4, 7, 1, 'ACC-LOG-001', 5, 430000, 19.00),
...
('Corsair K70 RGB PRO',
 ...
 649900, 10, 'https://www.corsair.com/medias/sys_master/images/images/hd0/h05/67192397578270/CH-9109410-NA.png', 4, 6, 0, 'ACC-COR-001', 3, 480000, 19.00),
...
('Logitech G733 Lightspeed',
 ...
 449900, 13, 'https://resource.logitechg.com/w_1000,c_limit,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/gaming/en/products/g733/g733-702x702-702x702.png', 4, 7, 0, 'ACC-LOG-002', 4, 320000, 19.00),
...
('ASUS VG249Q1A Monitor 24" Gaming',
 ...
 849900, 7, 'https://dlcdnwebimgs.asus.com/gain/BD15BDB5-E1BD-4CA6-BB0F-C7E9D6ABD3FD/w1000/h732', 4, 1, 1, 'ACC-ASUS-001', 2, 620000, 19.00),
...
('Kingston DataTraveler Max USB-C 256GB',
 ...
 149900, 35, 'https://media.kingston.com/kingston/product/ktc-product-flash-702x702.png', 4, 8, 0, 'ACC-KNG-001', 10, 95000, 19.00);